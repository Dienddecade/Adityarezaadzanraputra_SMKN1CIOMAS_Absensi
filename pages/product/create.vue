...
const formCreateProduct = [
  { name: "name", label: "Name", type: "text", value: "", placeholder: "Nama Lengkap", required: true },
  { name: "description", label: "Isi", type: "text", value: "", placeholder: "apa alasan mu", required: true },
  { name: "price", label: "Nomor absen", type: "number", value: "", placeholder: "1-34", required: true },
  { name: "image", label: "Image", type: "file", value: {}, placeholder: "", required: true },
  { name: "category", label: "Keterangan", type: "select", value: "", placeholder: "", required: true },
];
...
<template>
  <section class="flex justify-center py-10">
    <div class="w-[500px]">
      <h1 class="text-2xl mb-7 font-medium">ABSENSI</h1>
      ...
      <form @submit.prevent="createProduct">
        <div class="mb-6" v-for="(item, index) in formCreateProduct" :key="index">
          ...
          <select
            ...
            v-model="item.value"
          >
            <option disabled value="">Masukan Keterangan</option>
