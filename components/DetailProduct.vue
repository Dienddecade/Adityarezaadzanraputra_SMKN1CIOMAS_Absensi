...
items-center gap-1 py-2 px-5 rounded-full mb-7 cursor-pointer">
            ...
            <div class="flex items-center">
                ...
                <div class="w-1/2 bg-gray-300 mr-5 rounded-3xl flex justify-center items-center p-5 h-[500px]"><img :src="props.product.image" class="w-full h-full object-contain" /></div>
